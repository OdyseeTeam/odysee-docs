...
*This section is for syncing a YouTube channel to a brand new Odysee account. If you're trying to sync a YouTube channel to an existing account, jump to that section by clicking [here](#existing).*
...
You're not done quite yet, though. Click [here](#claim) to jump to the **Claiming Your Channel** section.