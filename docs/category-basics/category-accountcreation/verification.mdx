---
sidebar_position: 2
description: "Odysee Verification: To receive some LBRY (LBC) Credits"
tags:
  - Verification
...
Verification isn't required to use Odysee, but it's highly recommended. Verifying allows you to receive some LBRY Credits (LBC for short) simply by using Odysee. We require verification to receive some LBC this way to prevent abuse.
