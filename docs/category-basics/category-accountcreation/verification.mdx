...
Verification isn't required to use Odysee, but it's highly recommended. Verifying allows you to receive some Credits simply by using Odysee. We require verification to receive some Credits this way to prevent abuse.
