...
## <OdyseeIcon type="featured" style={{width: "32px", height: "32px"}} /> Featured {#featured}
...
## <OdyseeIcon type="pop culture" style={{width: "32px", height: "32px"}} /> Pop Culture {#pop-culture}
...
## <OdyseeIcon type="artists" style={{width: "32px", height: "32px"}} /> Artists {#artists}
...
## <OdyseeIcon type="education" style={{width: "32px", height: "32px"}} /> Education {#education}
...
## <OdyseeIcon type="comedy" style={{width: "32px", height: "32px"}} /> Comedy {#comedy}
...
## <OdyseeIcon type="lifestyle" style={{width: "32px", height: "32px"}} /> Lifestyle {#lifestyle}
...
## <OdyseeIcon type="music" style={{width: "32px", height: "32px"}} /> Music {#music}
...
## <OdyseeIcon type="sports" style={{width: "32px", height: "32px"}} /> Sports {#sports}
...
## <OdyseeIcon type="gaming" style={{width: "32px", height: "32px"}} /> Gaming {#gaming}
...
## <OdyseeIcon type="speaker" style={{width: "32px", height: "32px"}} /> Tech {#gaming}
...
## <OdyseeIcon type="dollar" style={{width: "32px", height: "32px"}} /> Finance 2.0 {#finance}
...
## <OdyseeIcon type="peace" style={{width: "32px", height: "32px"}} /> Spirituality {#spirituality}
...
## <OdyseeIcon type="aperature" style={{width: "32px", height: "32px"}} /> News & Politics {#news-and-politics}
...
## <OdyseeIcon type="universe" style={{width: "32px", height: "32px"}} /> Universe {#universe}
...
## <OdyseeIcon type="rabbithole" style={{width: "32px", height: "32px"}} /> Rabbit Hole {#rabbit-hole}
