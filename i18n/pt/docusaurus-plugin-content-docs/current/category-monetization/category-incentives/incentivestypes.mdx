...
The top portion of the screen will show the list of incentives offered. These are:

- **First load**: Launch your own channel by sharing a video.
- **Coveted Creator**: This incentive is given based on the total number of verified followers (followers with verified accounts) your channel has.
- **The Journey**: This incentive is given for following creators.
- **Weekly Watch**: This incentive is given for watching videos for at least 3 days in a given week.
- **Favorite Five**: This incentive is given for reposting content from 5 different creators.
