...
Lorsque vous êtes sur Odysee, vous avez peut-être remarqué l'icône Crédit <OdyseeIcon type="credits"/> et une valeur numérique sur la barre supérieure.

<Image src="/img/fr/Ajouteruncomptebancaire01.png" />

Cela indique votre nombre total de Crédits, et en cliquant dessus, vous accéderez à la page du portefeuille.
