...
function getIcon(inputType, style) {
  ...
  if (type == 'featured') {
	return (
	<svg style={style} xmlns="http://www.w3.org/2000/svg" viewBox="0 -4 24 24" overflow="visible" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="icon icon--Featured" aria-hidden="true"><circle cx="11.06" cy="9" r="3"></circle><path d="M14.03,9.53l4.53,4.531a1.414,1.414,0,0,1-2,2l-4.3-4.311"></path><line x1="8.939" y1="11.121" x2="13.181" y2="6.88"></line><line x1="15" y1="14.5" x2="15" y2="20.5"></line><line x1="13.5" y1="20.5" x2="16.5" y2="20.5"></line><ellipse cx="14.5" cy="21" rx="7.5" ry="2.5"></ellipse><line x1="11.439" y1="14" x2="7.642" y2="19.987"></line><path d="M22,21,20.141,1.947a.5.5,0,0,0-.92-.219L15.561,7.5"></path><path d="M4.5,2.5A2.231,2.231,0,0,0,7,5c-1.615-.006-2.418.86-2.5,2.5A2.211,2.211,0,0,0,2,5,2.232,2.232,0,0,0,4.5,2.5Z"></path><path d="M14,.5A2.231,2.231,0,0,0,16.5,3c-1.615-.006-2.418.86-2.5,2.5A2.211,2.211,0,0,0,11.5,3,2.232,2.232,0,0,0,14,.5Z"></path></svg>
	);
  }
  if (type == 'life') {
	return (
	  <svg style={style} xmlns="http://www.w3.org/2000/svg" viewBox="0 -4 24 24" overflow="visible" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon--Life" aria-hidden="true"><g><path d="M12 23.5L12 6.836"></path><path d="M12,6.836s2-1.291,2-3.228a4.144,4.144,0,0,0-1.69-3,.49.49,0,0,0-.621,0,4.143,4.143,0,0,0-1.689,3C10,5.545,12,6.836,12,6.836Z"></path><path d="M12,10.455s.9-4.038,6.093-4.038a.5.5,0,0,1,.419.8A7.942,7.942,0,0,1,12,10.455Z"></path><path d="M12,10.455s-.9-4.038-6.093-4.038a.5.5,0,0,0-.419.8A7.942,7.942,0,0,0,12,10.455Z"></path><path d="M12,15.455s1.809-4.31,7.6-3.2a.5.5,0,0,1,.262.858A8.855,8.855,0,0,1,12,15.455Z"></path><path d="M12,15.455s-1.809-4.31-7.6-3.2a.5.5,0,0,0-.262.858A8.855,8.855,0,0,0,12,15.455Z"></path><path d="M12,19.955s-2.767-3.766-8.139-1.331a.505.505,0,0,0-.054.9A8.853,8.853,0,0,0,12,19.955Z"></path><path d="M12,19.955s2.767-3.766,8.139-1.331a.505.505,0,0,1,.054.9A8.853,8.853,0,0,1,12,19.955Z"></path></g></svg>
	);
  }
  if (type == 'education') {
	return (
	  <svg style={style} xmlns="http://www.w3.org/2000/svg" viewBox="0 -4 24 24" overflow="visible" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon--Education" aria-hidden="true"><g><path d="M12,14c0-1.455,2.964-3.381,8.484-3.494a.508.508,0,0,1,.516.5v8.5a.5.5,0,0,1-.5.5c-5.533.11-8.5,2.038-8.5,3.5,0-1.457-2.971-3.385-8.5-3.5a.5.5,0,0,1-.5-.5v-8.5a.508.508,0,0,1,.516-.5C9.035,10.62,12,12.546,12,14Z"></path><path d="M12 14.001L12 23.376"></path><path d="M10,14.742A20.1,20.1,0,0,0,5.52,13.7"></path><path d="M10,17.742a20.265,20.265,0,0,0-4.521-1.048"></path><path d="M14,14.742a20.2,20.2,0,0,1,4.523-1.048"></path><path d="M14,17.742a20.213,20.213,0,0,1,4.524-1.048"></path><path d="M4.566,9A7.5,7.5,0,1,1,19.434,9"></path><path d="M9.624,9,9.189,7.259a1,1,0,0,0-.97-.758H4.651"></path><path d="M17.99,3.5H15.281a1,1,0,0,0-.97.758l-.5,2a1,1,0,0,0,.97,1.242h1.052l.245,1.469"></path></g></svg>
	);
  }
  if (type == 'aperature') {
	return (
	  <svg style={style} size="16" class="icon icon--Aperature" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 -4 24 24" overflow="visible" width="18" height="18" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><line x1="3.5" y1="3.5" x2="14.5" y2="3.5" id="Stroke-6102"></line><polygon id="Stroke-6103" points="3.5 12.5 8.5 12.5 8.5 6.5 3.5 6.5"></polygon><line x1="11.5" y1="8.5" x2="14.5" y2="8.5" id="Stroke-6104"></line><line x1="10.5" y1="10.5" x2="14.5" y2="10.5" id="Stroke-6105"></line><line x1="10.5" y1="12.5" x2="14.5" y2="12.5" id="Stroke-6106"></line><line x1="3.5" y1="14.5" x2="14.5" y2="14.5" id="Stroke-6107"></line><line x1="3.5" y1="16.5" x2="14.5" y2="16.5" id="Stroke-6108"></line><line x1="3.5" y1="18.5" x2="14.5" y2="18.5" id="Stroke-6109"></line><path d="M19.5,5.5 L21.5,5.5 L21.5,20.5 C21.5,21.052 21.053,21.5 20.5,21.5 C19.948,21.5 19.5,21.052 19.5,20.5 L19.5,2 L17.5,2 L17.5,4" id="Stroke-6110"></path><path d="M20.5,23.5 L3.5,23.5 C1.844,23.5 0.5,22.157 0.5,20.5 L0.5,0.5 L17.5,0.5 L17.5,20.5 C17.5,22.157 18.844,23.5 20.5,23.5 C22.157,23.5 23.5,22.157 23.5,20.5 L23.5,3.5 L19.5,3.5" id="Stroke-6111"></path></svg>
	);
  }
  if (type == 'peace') {
	return (
	  <svg style={style} size="16" class="icon icon--Peace" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 -4 24 24" overflow="visible" width="18" height="18" stroke="currentColor" fill="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><g transform="matrix(1,0,0,1,0,0)"><path d="M0.500 12.000 A11.500 11.500 0 1 0 23.500 12.000 A11.500 11.500 0 1 0 0.500 12.000 Z" fill="none" stroke-linecap="round" stroke-linejoin="round"></path><path d="M13.5,3.642a8.5,8.5,0,0,1,6.24,11.877L13.5,9.354Z" fill="none" stroke-linecap="round" stroke-linejoin="round"></path><path d="M13.5,13.6l4.471,4.455A8.529,8.529,0,0,1,13.5,20.365Z" fill="none" stroke-linecap="round" stroke-linejoin="round"></path><path d="M4.33,15.549,10.5,9.354V3.635A8.517,8.517,0,0,0,3.5,12,7.583,7.583,0,0,0,4.33,15.549Z" fill="none" stroke-linecap="round" stroke-linejoin="round"></path><path d="M10.5,20.364a8.543,8.543,0,0,1-4.463-2.306L10.5,13.6Z" fill="none" stroke-linecap="round" stroke-linejoin="round"></path></g></svg>
	);
  }
  if (type == 'pop culture') {
	return (
	  <svg style={style} xmlns="http://www.w3.org/2000/svg" viewBox="0 -4 24 24" overflow="visible" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon--Pop Culture" aria-hidden="true"><g><path d="M23.5,12.11a7,7,0,0,1-3.27,5.59.26.26,0,0,1-.32,0,.27.27,0,0,1-.05-.31A2.71,2.71,0,0,0,20,17c.65-1.4.5-2.85-.34-3.25s-2,.41-2.67,1.77c.06-.93-.26-1.7-.86-1.88-1.27-.4-1.77,1.24-4.17,5.44-2.44-4.27-2.9-5.84-4.17-5.44-.6.18-.92.95-.86,1.88-.66-1.36-1.84-2.15-2.67-1.77S3.31,15.63,4,17a2.71,2.71,0,0,0,.18.34.27.27,0,0,1,0,.31.26.26,0,0,1-.32,0A7,7,0,0,1,.5,12.11C.5,8.93,3.17,6.18,7,4.9a.25.25,0,0,1,.32.3L7,6.73a3.37,3.37,0,0,0,.78,3,1,1,0,0,0,1.1.28,1,1,0,0,0,.65-.94V5.61a.25.25,0,0,1,.4-.2l1.6,1.2h1l1.6-1.2a.25.25,0,0,1,.4.2V9.05a1,1,0,0,0,.65.94,1,1,0,0,0,1.1-.28,3.35,3.35,0,0,0,.78-3L16.65,5.2A.25.25,0,0,1,17,4.9C20.83,6.18,23.5,8.93,23.5,12.11Z"></path></g></svg>
	);
  }
  if (type == 'speaker') {
	return (
	  <svg style={style} size="16" class="icon icon--Speaker" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 -4 24 24" overflow="visible" width="18" height="18" stroke="currentColor" fill="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M13.5005,21.5 C13.5005,22.604 12.6055,23.5 11.5005,23.5 L2.5005,23.5 C1.3955,23.5 0.5005,22.604 0.5005,21.5 L0.5005,2.5 C0.5005,1.396 1.3955,0.5 2.5005,0.5 L11.5005,0.5 C12.6055,0.5 13.5005,1.396 13.5005,2.5 L13.5005,21.5 L13.5005,21.5 Z" id="Stroke-5155" stroke-linecap="round"></path><line x1="13.5005" y1="19.5" x2="0.5005" y2="19.5" id="Stroke-5156" stroke-linecap="round"></line><line x1="13.5005" y1="4.5" x2="0.5005" y2="4.5" id="Stroke-5157" stroke-linecap="round"></line><line x1="4.5005" y1="2.5" x2="9.5005" y2="2.5" id="Stroke-5158" stroke-linecap="round"></line><path d="M7.0005,22 C6.7245,22 6.5005,21.776 6.5005,21.5 C6.5005,21.224 6.7245,21 7.0005,21 C7.2765,21 7.5005,21.224 7.5005,21.5 C7.5005,21.776 7.2765,22 7.0005,22 L7.0005,22 Z" id="Stroke-5159"></path></svg>
	);
  }
  if (type == 'universe') {
	return (
	  <svg style={style} size="16" class="icon icon--Universe" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 -4 25 24" overflow="visible" width="18" height="18" stroke="currentColor" fill="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><g transform="matrix(1,0,0,1,0,0)"><path d="M5.33,17.848A9.545,9.545,0,0,1,16.466,2.488" fill="none" stroke-linecap="round" stroke-linejoin="round"></path><path d="M1.982,17.78C.769,19.905.363,21.554,1.048,22.24c1.04,1.039,4.294-.43,8.062-3.418" fill="none" stroke-linecap="round" stroke-linejoin="round"></path><path d="M13.423,18.067l-3.58-3.58L17.8,6.53A5.054,5.054,0,0,1,20.153,5.2L22.2,4.686a.844.844,0,0,1,1.023,1.023l-.512,2.048a5.059,5.059,0,0,1-1.332,2.352Z" fill="none" stroke-linecap="round" stroke-linejoin="round"></path><path d="M9.843,14.487,6.911,13.51a.422.422,0,0,1-.165-.7l1.022-1.022a3.383,3.383,0,0,1,3.462-.817l1.6.532Z" fill="none" stroke-linecap="round" stroke-linejoin="round"></path><path d="M13.423,18.067,14.4,21a.422.422,0,0,0,.7.165l1.022-1.022a3.383,3.383,0,0,0,.817-3.462l-.532-1.6Z" fill="none" stroke-linecap="round" stroke-linejoin="round"></path></g></svg>
	);
  }
  if (type == 'gaming') {
	return (
	  <svg style={style} size="16" class="icon icon--Gaming" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 -4 24 24" overflow="visible" width="18" height="18" stroke="currentColor" fill="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><g><path d="M17.5,9 C17.5,4.307 13.694,0.5 9,0.5 C4.306,0.5 0.5,4.307 0.5,9 L0.5,22.5 C0.5,23.051 0.95,23.5 1.5,23.5 L2,23.5 C2.551,23.5 3,23.051 3,22.5 C3,21.951 3.45,21.5 4,21.5 C4.551,21.5 5,21.951 5,22.5 C5,23.051 5.45,23.5 6,23.5 L7,23.5 C7.551,23.5 8,23.051 8,22.5 C8,21.951 8.45,21.5 9,21.5 C9.551,21.5 10,21.951 10,22.5 C10,23.051 10.45,23.5 11,23.5 L12,23.5 C12.551,23.5 13,23.051 13,22.5 C13,21.951 13.45,21.5 14,21.5 C14.551,21.5 15,21.951 15,22.5 C15,23.051 15.45,23.5 16,23.5 L16.5,23.5 C17.051,23.5 17.5,23.051 17.5,22.5 L17.5,9 L17.5,9 Z" id="Stroke-939"></path><path d="M13.5,12 C13.5,12.826 12.825,13.5 12,13.5 C11.176,13.5 10.5,12.826 10.5,12 L10.5,9 C10.5,8.176 11.176,7.5 12,7.5 C12.825,7.5 13.5,8.176 13.5,9 L13.5,12 L13.5,12 Z" id="Stroke-940"></path><path d="M11.5,11 C11.5,11.277 11.276,11.5 11,11.5 C10.724,11.5 10.5,11.277 10.5,11 C10.5,10.725 10.724,10.5 11,10.5 C11.276,10.5 11.5,10.725 11.5,11 L11.5,11 Z" id="Stroke-941"></path><path d="M7.5,12 C7.5,12.826 6.825,13.5 6,13.5 C5.176,13.5 4.5,12.826 4.5,12 L4.5,9 C4.5,8.176 5.176,7.5 6,7.5 C6.825,7.5 7.5,8.176 7.5,9 L7.5,12 L7.5,12 Z" id="Stroke-942"></path><path d="M5.5,11 C5.5,11.277 5.276,11.5 5,11.5 C4.724,11.5 4.5,11.277 4.5,11 C4.5,10.725 4.724,10.5 5,10.5 C5.276,10.5 5.5,10.725 5.5,11 L5.5,11 Z" id="Stroke-943"></path></g></svg>
	);
  }
  if (type == 'music') {
	return (
	  <svg style={style} xmlns="http://www.w3.org/2000/svg" viewBox="0 -4 24 24" overflow="visible" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon--MusicCategory" aria-hidden="true"><g><path d="M19.8 6.267a1 1 0 01-1.414 0l-1.411-1.414a1 1 0 010-1.415l.186-.186a1 1 0 01.391-.242l4.536-1.51a.927.927 0 01.949 1.535z"></path><path d="M16.975 4.853L9.55 12.277l1.414 1.414 7.425-7.424"></path><path d="M11.187 10.64a2.881 2.881 0 01-.8-2.538 6.278 6.278 0 01.738-1.99A1.15 1.15 0 009.3 4.749a6.56 6.56 0 00-1.91 3.406c-.22 1.038-1 2.463-2.1 2.485a4.638 4.638 0 00-4.6 4.746 5.927 5.927 0 001.812 4.249l1.1 1.1a5.93 5.93 0 004.249 1.812 4.639 4.639 0 004.746-4.6c0-1.1 1.235-1.789 2.286-1.755a4.13 4.13 0 003.324-1.269 1.1 1.1 0 00-.719-1.846c-3.306-.254-4-.141-4.891-1.029M7.782 13.338l2.122 2.121"></path><path d="M4.954 14.753l3.535 3.535-1.768 1.768-3.535-3.535z"></path></g></svg>
	);
  }
  if (type == 'lifestyle') {
	return (
	  <svg style={style} xmlns="http://www.w3.org/2000/svg" viewBox="0 -4 24 24" overflow="visible" width="18" height="18" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" class="icon icon--Lifestyle" aria-hidden="true"><path d="M8.906,8.611c1.116,1.278,1.285,2.824,1.61,4.761"></path><path d="M15.716,9.317c-.323,1.42-.689,2.852-.936,4.288"></path><path d="M10.93,3.98a1.75,1.75,0,0,0-2.664-1.5,1.748,1.748,0,0,0,.026-.261,1.759,1.759,0,0,0-3.518,0,1.748,1.748,0,0,0,.026.261,1.755,1.755,0,1,0-.953,3.257A1.753,1.753,0,1,0,6.533,7.894,1.753,1.753,0,1,0,9.219,5.735,1.759,1.759,0,0,0,10.93,3.98Z"></path><path d="M21.861,4.846a1.647,1.647,0,0,0-2.508-1.411,1.552,1.552,0,0,0,.024-.245,1.656,1.656,0,1,0-3.312,0,1.553,1.553,0,0,0,.025.245,1.652,1.652,0,1,0-.9,3.067A1.65,1.65,0,1,0,17.721,8.53a1.65,1.65,0,1,0,2.91-1.558A1.632,1.632,0,0,0,20.25,6.5,1.655,1.655,0,0,0,21.861,4.846Z"></path><path d="M15.169,15.265A5.643,5.643,0,0,1,12,19.291c-.355-1.493-3.135-3.5-1.707-5.658.705-1.065,2.384-.687,2.384-.687C14.481,12.883,15.415,13.753,15.169,15.265Z"></path><path d="M20.448,13.532a5.639,5.639,0,0,1-.782,5.062c-1.041-1.126-4.449-1.509-4.265-4.09.091-1.273,1.739-1.769,1.739-1.769C18.679,11.8,19.92,12.094,20.448,13.532Z"></path><path d="M7.938,13.2s1.661.449,1.788,1.719c.256,2.575-3.139,3.054-4.149,4.209a5.645,5.645,0,0,1-.924-5.039C5.141,12.64,6.373,12.306,7.938,13.2Z"></path><path d="M18.823,17.994l-.951,4.758a.983.983,0,0,1-.964.785H8.7a.982.982,0,0,1-.963-.785l-.9-4.487"></path><circle cx="6.566" cy="4.779" r="1"></circle><circle cx="17.723" cy="5.472" r="1"></circle></svg>
	);
  }
  if (type == 'comedy') {
	return (
	  <svg style={style} xmlns="http://www.w3.org/2000/svg" viewBox="0 -4 24 24" overflow="visible" width="18" height="18" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" class="icon icon--Comedy" aria-hidden="true"><path d="M2.000 13.500 A10.000 10.000 0 1 0 22.000 13.500 A10.000 10.000 0 1 0 2.000 13.500 Z"></path><path d="M2.834,9.495A2.5,2.5,0,0,1,1.5,5,2.5,2.5,0,1,1,5,1.5,2.5,2.5,0,0,1,9.35,3.855"></path><path d="M21.166,9.495A2.5,2.5,0,0,0,22.5,5,2.5,2.5,0,1,0,19,1.5a2.5,2.5,0,0,0-4.35,2.355"></path><path d="M8.500 14.000 A3.500 3.500 0 1 0 15.500 14.000 A3.500 3.500 0 1 0 8.500 14.000 Z"></path><path d="M18.5,14a6.5,6.5,0,0,1-13,0"></path><path d="M8.5 7L8.5 10"></path><path d="M10 8.5L7 8.5"></path><path d="M15.5 7L15.5 10"></path><path d="M17 8.5L14 8.5"></path></svg>
	);
  }
  if (type == 'artists') {
	return (
	  <svg style={style} xmlns="http://www.w3.org/2000/svg" viewBox="0 -4 24 24" overflow="visible" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon--Artists" aria-hidden="true"><g><path d="M10.107,16.884,22.372,4.657a2.5,2.5,0,0,0-3.744-3.314L7.954,15.04"></path><path d="M1.285,22.879a.5.5,0,0,1,.027-.915C3.693,21,2.926,18.286,3.633,16.835a3.56,3.56,0,0,1,4.728-1.627C13.677,17.8,7.349,25.765,1.285,22.879Z"></path></g></svg>
	);
  }
  if (type == 'sports') {
	return (
	  <svg style={style} xmlns="http://www.w3.org/2000/svg" viewBox="0 -4 24 24" overflow="visible" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon--Sports" aria-hidden="true"><svg style={style} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><g transform="matrix(2,0,0,2,0,0)"><circle cx="12" cy="12" r="11.5"></circle><path d="M3.59,19.85C5,15.6,9.28,6.37,20.47,4.24"></path><path d="M3.46,4.29C8,5.94,16.56,10.52,18.37,21.58"></path><path d="M10.54.59A8.52,8.52,0,0,1,.81,9.42"></path><path d="M11.79,23.5C7,15.82,15.94,6.89,23.5,11.7"></path></g></svg></svg>
	);
  }
  if (type == 'rabbithole') {
	return (
	  <svg style={style} xmlns="http://www.w3.org/2000/svg" viewBox="0 -4 24 24" overflow="visible" width="18" height="18" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" class="icon icon--RabbitHole" aria-hidden="true"><path d="M17.865,21.451a.5.5,0,0,1-.488.609H6.123a.5.5,0,0,1-.488-.609L7.5,13.06H16Z"></path><path d="M4 13.06L20 13.06"></path><path d="M6.611 17.06L16.889 17.06"></path><path d="M11,13.06a47.171,47.171,0,0,0-1.5-8c-.851-2.554-2.077-3.474-3.5-3-1.5.5-1,2-.5,4s2.5,7,2.5,7"></path><path d="M15,13.06l1.067-3.18a4.529,4.529,0,0,0,.943.37c1.195.318,2.263-.393,1.7-1.683A7.652,7.652,0,0,0,16.648,6.02C16,5.446,14.9,4.456,13.972,5.071,12.216,6.241,11.5,13.06,11.5,13.06"></path></svg>
	);
  }
  if (type == 'heart') {
	return (
	  <svg style={style} xmlns="http://www.w3.org/2000/svg" viewBox="0 -4 24 24" overflow="visible" width="18" height="18" fill="currentColor" stroke="#FFFFFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon--Heart" aria-hidden="true"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>
	);
  }
  if (type == 'home') {
	return (
	  <svg style={style} xmlns="http://www.w3.org/2000/svg" viewBox="0 -4 24 24" overflow="visible" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon--Home" aria-hidden="true"><g fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round"><path d="M1, 11 L12, 2 C12, 2 22.9999989, 11.0000005 23, 11"></path><path d="M3, 10 C3, 10 3, 10.4453982 3, 10.9968336 L3, 20.0170446 C3, 20.5675806 3.43788135, 21.0138782 4.00292933, 21.0138781 L8.99707067, 21.0138779 C9.55097324, 21.0138779 10, 20.5751284 10, 20.0089602 L10, 15.0049177 C10, 14.449917 10.4433532, 14 11.0093689, 14 L12.9906311, 14 C13.5480902, 14 14, 14.4387495 14, 15.0049177 L14, 20.0089602 C14, 20.5639609 14.4378817, 21.0138779 15.0029302, 21.0138779 L19.9970758, 21.0138781 C20.5509789, 21.0138782 21.000006, 20.56848 21.000006, 20.0170446 L21.0000057, 10"></path></g></svg>
	);
  }
  if (type == 'trash') {
	  return (
